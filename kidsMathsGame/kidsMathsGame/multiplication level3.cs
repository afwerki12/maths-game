...
{
    public partial class multiplication_level3 : Form
    {
        ...
        {
            devisionlevel3 frm2 = new devisionlevel3(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }
        ...
        {
            subtractionlevel3 frm3 = new subtractionlevel3(this.txtusername.Text);
            frm3.ShowDialog();
            this.Hide();
        }

        public multiplication_level3()
        {
            InitializeComponent();
        }
        public multiplication_level3(string str)
        {
            InitializeComponent();
