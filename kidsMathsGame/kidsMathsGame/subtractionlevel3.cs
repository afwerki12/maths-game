...
{
    public partial class subtractionlevel3 : Form
    {
        public int firstNumber, secondNumber, timerLeft, score;

        private void btnback_Click(object sender, EventArgs e)
        {
            additionlevel3 frm2 = new additionlevel3(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }
        ...
        {
               multiplication_level3 frm2 = new multiplication_level3(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }

        public subtractionlevel3()
        {
            InitializeComponent();
        }
        public subtractionlevel3(string str)
        {
            InitializeComponent();
