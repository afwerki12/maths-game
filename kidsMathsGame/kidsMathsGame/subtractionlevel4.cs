...
{
    public partial class subtractionlevel4 : Form
    {
        ...
        {
            additionlevel4 frm2 = new additionlevel4(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }
        ...
        {
            multiplicationlevel4 frm4 = new multiplicationlevel4(this.txtusername.Text);
            frm4.ShowDialog();
            this.Hide();
        }

        public subtractionlevel4()
        {
            InitializeComponent();
        }
        public subtractionlevel4(string str)
        {
            InitializeComponent();
