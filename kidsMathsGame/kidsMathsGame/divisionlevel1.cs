...
{
    public partial class divisionlevel1 : Form
    {
        public int firstNumber, secondNumber, timerLeft, score;
        public divisionlevel1()
        {
            InitializeComponent();
        }
        public divisionlevel1(string str)
        {
            InitializeComponent();
        ...
        {
            multiplicationlevel1 frm2 = new multiplicationlevel1(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }
