...
{
    public partial class additionlevel3 : Form
    {
        ...
        {
            subtractionlevel3 frm2 = new subtractionlevel3(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }

        public additionlevel3()
        {
            InitializeComponent();
        }
        public additionlevel3(string str)
        {
            InitializeComponent();
