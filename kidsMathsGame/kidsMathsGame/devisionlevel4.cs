...
{
    public partial class devisionlevel4 : Form
    {
        public int firstNumber, secondNumber, timerLeft, score;
        public devisionlevel4()
        {
            InitializeComponent();
        }
        public devisionlevel4(string str)
        {
            InitializeComponent();
            this.txtaswerbox.Text = str;
        }
        ...
        {
            multiplicationlevel4 multi4 = new multiplicationlevel4(this.txtusername.Text);
            multi4.ShowDialog();
            this.Hide();
        }
        ...
        {
             ceritficate cir = new ceritficate(this.txtusername.Text);
            cir.ShowDialog();
            this.Hide();
        }
