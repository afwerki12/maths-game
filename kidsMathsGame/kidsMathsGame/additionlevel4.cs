...
{
    public partial class additionlevel4 : Form
    {
        ...
        {
            subtractionlevel4 frm4 = new subtractionlevel4(this.txtusername.Text);
            frm4.ShowDialog();
            this.Hide();
        }
        ...
        public additionlevel4()
        {
            InitializeComponent();
        }
        public additionlevel4(string str)
        {
            InitializeComponent();
