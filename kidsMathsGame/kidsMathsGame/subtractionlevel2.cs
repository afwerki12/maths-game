...
{
    public partial class subtractionlevel2 : Form
    {
        ...
        {
            additionlevel2 frm2 = new additionlevel2(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }
        ...
        {
            multiplicationlevel2 frm2 = new multiplicationlevel2(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }

        public subtractionlevel2()
        {
            InitializeComponent();
        }
        public subtractionlevel2(string str)
        {
            InitializeComponent();
