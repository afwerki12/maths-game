...
{
    public partial class additionlevel2 : Form
    {
        ...
        {
            divisionlevel1 frm2 = new divisionlevel1(this.txtusername.Text);
            frm2.ShowDialog();
            this.Hide();
        }

        public additionlevel2(string stri)
        {
            InitializeComponent();
            this.txtusername.Text = stri;
        }
