...
{
    public partial class devisionlevel3 : Form
    {
        ...
        {
            additionlevel4 ad4 = new additionlevel4(this.txtusername.Text);
            ad4.ShowDialog();
            this.Hide();
        }

        public devisionlevel3()
        {
            InitializeComponent();
        }
        public devisionlevel3(string str)
        {
            InitializeComponent();
